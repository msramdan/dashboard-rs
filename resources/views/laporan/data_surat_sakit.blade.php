            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Di bawah ini adalah laporan Data Surat Sakit') }}
                    </p>
                </div>
                <x-breadcrumb>
...
@push('js')
    ...
    <script>
        let columns = [{
            ...
            {
                data: 'tglperiksa',
                name: 'tbl_rekammedisrs.tglperiksa'
            },
            {
                data: 'namapas',
    ...
    <script>
        ...
        var exportData = function() {
            ...
            var url = '/export-data_surat_sakit/' + start_date + '/' + end_date;
            console.log(url);
            $.ajax({
                url: url,
                type: 'GET',
                ...
                success: function(data) {
                    ...
                    var nameFile = 'Laporan Data Surat Sakit.xlsx'
