            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Di bawah ini adalah laporan kunjungan pasien') }}
                    </p>
                </div>
                <x-breadcrumb>
...
@push('js')
    ...
    <script>
        ...
        function replaceURLParams() {
            ...
            var newURL = "{{ route('kunjungan_pasien') }}" + '?' + params.toString();
    ...
    <script>
        ...
        var exportData = function() {
            ...
            var url = '/export-kunjungan-pasien/' + start_date + '/' + end_date;
            $.ajax({
                url: url,
                type: 'GET',
                headers: {
                ...
                success: function(data) {
                    ...
                    var nameFile = 'Laporan kunjungan pasien.xlsx'
